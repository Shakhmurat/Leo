...
// SCRIPTS
// with webpack for fronend files
gulp.task('scripts', () => {
  // for multple bundles use object like this
  // entry: {
  //   bundleA: './frontend/scripts/bundleA/bundleA.js',
  //   bundleB: './frontend/scripts/bundleB/bundleB.js'
  // }
  ...
  return webpack({
      entry: {
        main: './' + PATHS.src + '/scripts/main/main.js'
      },
      output: {
        filename: '[name].js'
      },
